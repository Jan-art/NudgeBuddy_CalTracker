...
// Notification Service class to store the data for the notifications in the notification screen. Used in the NotificationScreen class. Used along with local_notifications.dart.
//================================================================================================================================================================================
class NotificationService {
  static Future<void> addNotification(
    ...
    try {
      ...
      Random rand = Random();
      int notifyID = rand.nextInt(9999); //GENERATING RANDOM ID FOR NOTIFICATION
  ...
  //CHECKING IF NOTIFICATION IS PAST
  ...
  //GETTING LATEST DATE FOR NOTIFICATION
