...
// Nutrient Service class to store the data for the nutrients in the stats screen. 
//==================================================================================================================================================================
class NutrientService {
  ...
  static Future<void> getLastFourDaysKcal() async {
    final authCont = Get.find<AuthController>();
    try {
...
//GET LAST 4 DAYS WIDGET AT BOTTOM OF HOME SCREEN
 static List<String> getLastFourDays() {
