...
// Diet Advice Model Class holds the data for the Nutrition Advice Screen, which contains posts about nutrional advice, along with links to related articles. Used in the DietAdviceController class.
//=============================================================================================================================================================
class DietModel {
  String image, title, desciption, articleText, articleURL; //image is the image url, articleText is the text that will be displayed in the article, articleURL is the url to the article
