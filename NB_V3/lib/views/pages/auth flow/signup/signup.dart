...
// SignupPage class renders the "Submit" page, which is the last page of the signup flow if the user is signing up for the first time
// ==================================================================================================================================================================
class SignupPage extends GetWidget<AuthController> {
  ...
  // sectionsTitle is the title of each section of the signup flow
