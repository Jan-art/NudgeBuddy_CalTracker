...
// LoginPage class renders the login page for the user to enter their email and password to login
class LoginPage extends  GetWidget<AuthController> {
  LoginPage({super.key});
  

  @override
  Widget build(BuildContext context) { // Build the login widget
    return Obx(
      ()=> ShowLoading(
