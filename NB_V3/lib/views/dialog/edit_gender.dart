...
// EditGender allows to edit the user gender if incorrect from the personal info page
// ==============================================================================================================================================================================
class EditGender extends StatelessWidget {
  const EditGender({super.key});

  @override
  Widget build(BuildContext context) { // Builds the dialog box widget to edit said information
    return Material(
