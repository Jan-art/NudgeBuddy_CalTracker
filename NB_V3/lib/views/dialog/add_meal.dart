...
//AddMealDialog  class checks if the user is adding a new meal or editing an existing meal. It then displays the dialog box on the screen to track the new food instance.
//==============================================================================================================================================================================
...
// Save Meal logic
  _onSave() async {
    if (_validate()) { // Validates the input fields
      ...
      _clearingValues(); // Clears the input fields
      }
    } else {
